...
public class Initializer implements WithSimplePersistenceUnit {
  ...
  private Initializer roles() {
    ...
    entityManager().persist(miembroComunidad);
  ...
  private Initializer usuariosIniciales() {
    ...
    entityManager().persist(matiAdmin);
    entityManager().persist(usuarioMaria);
    entityManager().persist(usuarioJose);
    entityManager().persist(usuarioPaula);
    entityManager().persist(usuarioSergio);
    entityManager().persist(usuarioHoracio);
    entityManager().persist(usuarioRoxana);
    entityManager().persist(usuarioCamila);
    entityManager().persist(usuarioJulia);
    entityManager().persist(usuarioTamara);

    entityManager().persist(usuarioTomas);
    entityManager().persist(usuarioOlga);
    entityManager().persist(usuarioJesica);
    entityManager().persist(usuarioOctavio);
    entityManager().persist(usuarioAugusto);
    entityManager().persist(usuarioSofia);
    entityManager().persist(usuarioPaolo);
    entityManager().persist(usuarioRodrigo);
    entityManager().persist(usuarioCristina);

    entityManager().persist(usuarioFernando);
    entityManager().persist(usuarioVictoria);
    entityManager().persist(usuarioJoaquin);
    entityManager().persist(usuarioLeticia);
    entityManager().persist(usuarioDaiana);
    entityManager().persist(usuarioLuis);
    entityManager().persist(usuarioNatalia);
    entityManager().persist(usuarioCeleste);
  ...
  private Initializer guardarMiembro2() throws IOException {
    ...
    List<Comunidad>interesadosEnRetiro = new ArrayList<>();
    ...
    interesadosEnRetiro.add(comunidadVecinosRetiro);
    ...
    //comunidadesMatiAdmin.add(comunidadSubteLineaB);
    ...
    prestacionEscaleraMecanicaPrincipal.setComunidadesInteresadas(interesadosEnRetiro);
    prestacionesDeInteres.add(prestacionEscaleraMecanicaPrincipal);
    ...
    prestacionBaniosRetiro.setComunidadesInteresadas(interesadosEnRetiro);
    prestacionesDeInteres.add(prestacionBaniosRetiro);
    ...
    prestacionAscensorRetiro.setComunidadesInteresadas(interesadosEnRetiro);
    prestacionesDeInteres.add(prestacionAscensorRetiro);
    ...
    prestacionAscensorRetiroSecundario.setComunidadesInteresadas(interesadosEnRetiro);
    prestacionesDeInteres.add(prestacionAscensorRetiroSecundario);
    ...
    entityManager().persist(estacionRetiro);
    entityManager().persist(incidenteEscaleraRetiro);
    entityManager().persist(prestacionEscaleraMecanicaPrincipal);
    entityManager().persist(comunidadVecinosRetiro);
    entityManager().persist(escaleraMecanicaRetiro1);
    entityManager().persist(ascensorRetiro1);
    entityManager().persist(ascensorRetiro2);
    entityManager().persist(banioHombresRetiro);
    entityManager().persist(incidenteRetiro2);
    entityManager().persist(prestacionBaniosRetiro);
    entityManager().persist(incidenteRetiro3);
    entityManager().persist(prestacionAscensorRetiro);
    entityManager().persist(incidenteRetiro4);
    entityManager().persist(prestacionAscensorRetiroSecundario);
    entityManager().persist(tramo1);
    entityManager().persist(tramo2);
    entityManager().persist(tramo3);
    entityManager().persist(tramo4);
    ...
    */
    ...
    entityManager().persist(miembroMatias);
    entityManager().persist(miembroJuan);
    entityManager().persist(miembroMaria);
    entityManager().persist(miembroJose);
    entityManager().persist(miembroPaula);
    entityManager().persist(miembroSergio);
    entityManager().persist(miembroHoracio);
    entityManager().persist(miembroRoxana);
    entityManager().persist(miembroCamila);
    entityManager().persist(miembroJulia);
    entityManager().persist(miembroTamara);
    entityManager().persist(miembroTomas);
    entityManager().persist(miembroOlga);
    entityManager().persist(miembroJesica);
    entityManager().persist(miembroOctavio);
    entityManager().persist(miembroAugusto);
    entityManager().persist(miembroSofia);
    entityManager().persist(miembroPaolo);
    entityManager().persist(miembroRodrigo);
    entityManager().persist(miembroCristina);
    entityManager().persist(miembroFernando);
    entityManager().persist(miembroVictoria);
    entityManager().persist(miembroJoaquin);
    entityManager().persist(miembroLeticia);
    entityManager().persist(miembroDiana);
    entityManager().persist(miembroLuis);
    entityManager().persist(miembroNatalia);
    entityManager().persist(miembroCeleste);
